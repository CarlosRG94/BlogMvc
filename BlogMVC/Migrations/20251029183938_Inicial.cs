        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortadaUrl = table.Column<string>(type: "text", unicode: false, nullable: true),
                    FechaPublicacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UsuarioCreacionId = table.Column<string>(type: "text", nullable: false),
                    UsuarioActualizacionId = table.Column<string>(type: "text", nullable: true),
