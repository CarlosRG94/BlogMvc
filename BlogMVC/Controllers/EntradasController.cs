...
namespace BlogMVC.Controllers
{
    public class EntradasController:Controller
    {
        ...
        public async Task<IActionResult> Detalle(int id)
        {
            ...
            {
                // Reaplicamos el filtro de Comentarios borrados
                entrada.Comentarios = entrada.Comentarios
                    .Where(c => !c.Borrado)
                    .ToList();
            }
        ...
        public async Task<IActionResult> Crear(EntradaCrearViewModel modelo)
        {
            ...
            }else if(modelo.ImagenPortadaIA is not null)
            {
                ...
                string usuarioId = servicioUsuarios.ObtenerUsarioId()!;
        ...
        public async Task<IActionResult> GenerarImagen([FromQuery] string titulo)
        {
            ...
            //{
                //var rutaImagen = Path.Combine(env.WebRootPath, "img", "404.png");
